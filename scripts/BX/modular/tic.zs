...
count+=1;
RecipeBuilder.newBuilder(name+count,"tic",400)
.addItemOutput(<taiga:adamant_ingot>*36)
.addItemInput(<taiga:vibranium_ingot>*12)
.addItemInput(<taiga:eezo_ingot>*74)  //零素
.addItemInput(<taiga:abyssum_ingot>*75)  //深渊金属
.addItemInput(<taiga:osram_ingot>*74)  //熔金
.addItemInput(<minecraft:obsidian>*162)
.addItemInput(<taiga:meteoritecobble_block>*162)
.addItemInput(<taiga:valyrium_ingot>*12)  
.addItemInput(<taiga:uru_ingot>*12) //雾金
