...
import scripts.BX.creative.soul.soul;
import scripts.BX.creative.soul.addSuperRecipe;

var ns = <minecraft:nether_star>;

addSuperRecipe(ns,<additions:bxloveu-broken_star>,"broken_star");
...
var o =<additions:bxloveu-ouhuang_ingot>;
...
FusionCrafting.add(<additions:bxloveu-soul_gem_chunk>*2,<additions:bxloveu-star_power>,FusionCrafting.CHAOTIC,2147483647,[
    <additions:bxloveu-creative_soul>,<additions:bxloveu-mt>
]);

FusionCrafting.add(<additions:bxloveu-soul_gem_chunk>*7,<additions:bxloveu-star_power>,FusionCrafting.CHAOTIC,2147483647,[
    <additions:bxloveu-creative_soul>,<additions:bxloveu-creative_soul>,<additions:bxloveu-creative_soul>,<additions:bxloveu-mt>
]);

FusionCrafting.add(<additions:bxloveu-soul_gem_chunk>*12,<additions:bxloveu-star_power>,FusionCrafting.CHAOTIC,2147483647,[
    <additions:bxloveu-creative_soul>,<additions:bxloveu-creative_soul>,<additions:bxloveu-creative_soul>,
    <additions:bxloveu-creative_soul>,<additions:bxloveu-creative_soul>,<additions:bxloveu-mt>
]);
