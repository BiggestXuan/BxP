...
RecipeBuilder.newBuilder("qd"+count,"qd",1).
addItemInput(<bloodarsenal:blood_diamond:1>*64)
.addItemInput(<bloodarsenal:blood_diamond:1>*64)
.addItemInput(<bloodarsenal:blood_diamond:2>*64)
.addItemInput(<bloodarsenal:blood_diamond:3>*32)
.addItemOutput(nqd[6])
.build();
count+=1;

RecipeBuilder.newBuilder("qd"+count,"qd",1).
addItemInput(<twilightforest:block_storage:1>*64)
.addItemInput(<twilightforest:block_storage:1>*64)
.addItemInput(<twilightforest:knightmetal_block>*64)
.addItemInput(<twilightforest:knightmetal_block>*64)
.addItemOutput(nqd[7])
.build();
count+=1;
...
RecipeBuilder.newBuilder("qd"+count,"qd",1).
addItemInput(<abyssalcraft:ingotblock:3>*64)
.addItemInput(<abyssalcraft:ingotblock:3>*64)
.addItemInput(<abyssalcraft:ingotblock:3>*64)
.addItemInput(<abyssalcraft:ingotblock:3>*64)
.addItemInput(<abyssalcraft:ingotblock:3>*64)
...
RecipeBuilder.newBuilder("qd"+count,"qd",1).
addItemInput(<deepmoblearning:infused_ingot_block>*64)
.addItemInput(<deepmoblearning:infused_ingot_block>*64)
.addItemInput(<deepmoblearning:infused_ingot_block>*64)
.addItemInput(<deepmoblearning:infused_ingot_block>*64)
.addItemInput(<deepmoblearning:infused_ingot_block>*64)
...
RecipeBuilder.newBuilder("qd"+count,"qd",1).
addItemInput(<tconevo:metal_block>)
.addItemInput(<tconevo:metal_block>)
.addItemInput(<tconevo:metal_block>*4)
.addItemInput(<tconevo:metal_block>*5)
.addItemInput(<tconevo:metal_block>)
.addItemInput(<tconevo:metal_block>*4)
...
RecipeBuilder.newBuilder("qd"+count,"qd",1).
addItemInput(<thaumadditions:mithminite_ingot>)
.addItemInput(<thaumadditions:mithminite_ingot>)
.addItemInput(<thaumadditions:mithminite_ingot>)
.addItemInput(<thaumadditions:mithminite_ingot>)
.addItemInput(<thaumadditions:mithminite_ingot>)
...
RecipeBuilder.newBuilder("qd"+count,"qd",1).
addItemInput(<additions:bxloveu-tulye_haie>*64)
.addItemInput(<additions:bxloveu-tulye_haie>*64)
.addItemInput(<additions:bxloveu-tulye_haie>*64)
.addItemInput(<additions:bxloveu-tulye_haie>*64)
.addItemInput(<additions:bxloveu-tulye_haie>*64)
